...
var DemoAdapterConstants = (function () {
    ...
    DemoAdapterConstants.JANE_DOE = 3;
...
var DemoServerAdapter = (function () {
    function DemoServerAdapter(clientAdapter) {
        ...
        myUser.Email = "john.doe@gmail.com";
        myUser.ProfilePictureUrl = "images/JohnDoe_50x50.jpg";
        myUser.Status = 1 /* Online */;
		
		// configuring users
        var JaneDoe = new ChatUserInfo();
        JaneDoe.Id = DemoAdapterConstants.JANE_DOE;
        JaneDoe.RoomId = DemoAdapterConstants.DEFAULT_ROOM_ID;
        JaneDoe.Name = "Jane Doe";
        JaneDoe.Email = "jane.doe@gmail.com";
        JaneDoe.ProfilePictureUrl = "images/UserProfile2_55x55.jpg";
        JaneDoe.Status = 1 /* Online */;
        ...
        echoBotUser.Name = "Jack Berry";
        echoBotUser.Email = "jack.berry@gmail.com";
        echoBotUser.ProfilePictureUrl = "images/UserProfile3_55x55.jpg";
